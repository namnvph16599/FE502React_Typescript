...
type Props = {
  handlePushDataEditCate : (data : CategoryTypes) => void
}

const CategoryEdit = (props: Props) => {
  const navigate = useNavigate()
  const { id } = useParams();
  const { register, handleSubmit, formState: { errors }, reset } = useForm<CategoryTypes>()
  const onSubmit: SubmitHandler<CategoryTypes> = (data) => {
    props.handlePushDataEditCate(data);
