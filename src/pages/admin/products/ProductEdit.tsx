...
type Props = {
  onUpdate: (products: ProductsType) => void
}
type FormInput = {
  id?: number,
  price: number,
  ...
  return (
    <div>
      ...
      <div className="sm:flex items-center justify-between">
          <p className="focus:outline-none text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal 
            text-gray-800">Products Edit</p>
          <a href="/admin/products" className="sm:ml-3">
            <Link to="/admin/products/add">
              <button type="button" className="mr-4 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Add
              </button>
            </Link>
              ...
              <div className="shadow sm:rounded-md sm:overflow-hidden">
                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                  ...
                  {/* <div>
                    ...
                    <div className="mt-1">
                      <textarea id="about" {...register('description')} name="description" className="p-4 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-base border border-gray-300 rounded-md" placeholder=""></textarea>
                    </div>
                  </div> */}
    ...
    <button>Add</button>
      ...
      {/* <form action="" onSubmit={handleSubmit(onSubmit)}>
        ...
        {errors.name && <span>Nhap name</span>}
        <br />
