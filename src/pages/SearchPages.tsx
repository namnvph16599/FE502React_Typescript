...
import { getProdutcsSearch } from "../api/products"
type Props = {}
...
const SearchPages = (props: Props) => {
    ...
    useEffect(() => {
        const getProducts = async () => {
            const { data } = await getProdutcsSearch(search);
        ...
        <div>
            <div className="2xl:container 2xl:mx-auto">
                <div className="bg-gray-50 dark:bg-gray-900 text-center lg:py-10 md:py-8 py-6">
                    <p className="w-10/12 mx-auto md:w-full font-semibold lg:text-4xl text-3xl lg:leading-9 md:leading-7 dark:text-white leading-9 text-center text-gray-800">Products Search</p>
                </div>
